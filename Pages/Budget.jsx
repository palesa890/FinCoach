              ...
              {creditProfile ? (
                ...
                <div className="text-center py-12">
                  ...
                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 max-w-md mx-auto mb-6">
                    <h4 className="font-medium text-blue-800 mb-2">📄 Bank Statement Requirements</h4>
                    <ul className="text-sm text-blue-700 text-left space-y-1">
                      <li>• Must be a PDF format</li>
                      <li>• Filename should contain "statement" or "bank"</li>
                      <li>• Should show at least one month of transactions</li>
                      <li>• Must be from a recognized South African bank</li>
                    </ul>
                  </div>
                  <Button 
                    onClick={() => setShowStatementUpload(true)}
